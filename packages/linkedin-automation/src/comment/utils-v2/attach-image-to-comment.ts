...
export async function attachImageToComment(
  ...
  try {
    ...
    // Click "Share photo" - LinkedIn creates the file input but picker won't open
    addPhotoBtn.click();
    ...
    if (!fileInput) {
      console.warn("EngageKit: File input not found after clicking Share photo (v2)");
      return false;
    }
    ...
    console.log("EngageKit: Image attached successfully (v2)");
    return true;
  } catch (error) {
