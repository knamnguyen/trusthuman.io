...
export const SampleVideoScalarFieldEnumSchema = z.enum(['id','webpageUrl','s3Url','hookCutUrl','title','description','views','comments','likes','durationSeconds','createdAt','updatedAt']);
