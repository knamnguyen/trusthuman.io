...
export const getPostCommentSystemPrompt = ({
  ...
  // Build word limit instruction if specified
  const wordLimitInstruction = maxWords
    ? `\n- IMPORTANT: Keep your comment under ${maxWords} words maximum.`
    : "";
...
- avoid generic responses.${wordLimitInstruction}
