        ...
        <section id='how-it-works' className='container max-w-6xl py-16 md:py-24'>
            <div className='flex flex-col gap-16'>
                <div className='mx-auto max-w-2xl space-y-6 md:text-center'>
                    <h2 className='text-balance text-2xl font-bold sm:text-4xl md:text-5xl'>
                        How to Use{' '}
                ...
                <div className='flex flex-wrap items-center'>
                        ...
                        <ol className='relative border-s'>
                            {Steps.map((step, index) => (
                                <li key={step.title} className='mb-10 ms-4'>
                                    ...
                                    <h3 className='text-lg/relaxed font-semibold'>{step.title}</h3>
                    ...
                    <div className='w-full pt-24 md:w-7/12 md:pt-0'>
                        <video
                            ...
                            <source src={`${ASSET_BASE}/screen-rec.mov`} type='video/quicktime' />
                        </video>
                    </div>
                </div>
            </div>
