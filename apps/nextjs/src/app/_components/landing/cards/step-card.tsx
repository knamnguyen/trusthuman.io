        ...
        <>
          ...
          <div className="w-full px-4 pt-8 md:w-7/12 md:px-0 md:pt-0 md:pl-16">
            <video
              ...
              className="m-auto rounded-lg border shadow-xl md:max-h-[350px] md:object-cover md:object-left md:[transform:scale(1.3)_perspective(1040px)_rotateY(-11deg)_rotateX(2deg)_rotate(2deg)]"
            >
        ...
        <>
          ...
          <div className="w-full px-4 pt-8 md:w-7/12 md:px-0 md:pt-0 md:pr-16 order-2 md:order-1">
            <video
              ...
              playsInline
              aria-label={`Demo video showing ${title}`}
              className="m-auto rounded-lg border shadow-xl md:max-h-[350px] md:object-cover md:object-right md:[transform:scale(1.3)_perspective(1040px)_rotateY(11deg)_rotateX(2deg)_rotate(-2deg)]"
            >
              <source src={videoPath} type="video/mp4" />
              Your browser does not support the video tag.
            </video>
