/**
 * Browser-injected utilities bundle.
 * This file is compiled by Bun.build() and eval'd in the browser page.
 * It exposes window.engagekitInternals for MCP workflows to call via page.evaluate().
 *
 * Copied from packages/api/src/utils/browser-session/utilities.ts
 */
