...
import type { ContentImpressionsData } from "../utils/data-fetch-mimic/linkedin-content-impressions-fetcher";

interface ContentImpressionsChartProps {
...
export function ContentImpressionsChart({
  snapshots,
  compact = false,
}: ContentImpressionsChartProps) {
  ...
  return (
    <Card>
      <CardHeader className="pb-3">
        ...
        <CardDescription>
          Content impressions over {snapshots.length} snapshots
        </CardDescription>
      </CardHeader>
