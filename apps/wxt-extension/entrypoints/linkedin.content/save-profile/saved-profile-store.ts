...
interface SavedProfileState {
  ...
  /** Loading state for profile URN fetch */
  isLoadingProfileUrn: boolean;
...
interface SavedProfileActions {
  ...
  setIsLoadingProfileUrn: (loading: boolean) => void;
...
export const useSavedProfileStore = create<SavedProfileStore>((set) => ({
  ...
  setIsLoadingProfileUrn: (loading) => set({ isLoadingProfileUrn: loading }),
